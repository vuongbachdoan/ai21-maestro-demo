// Simplified AI21 client for direct API calls
export async function callAI21Chat(message: string, apiKey: string, conversationHistory: any[] = []) {
  const messages = [
    {
      role: 'system',
      content: `You are a helpful fashion assistant for an online clothing store. Follow this exact process:
